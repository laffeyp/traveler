...
v0.8 is the shipping baseline for sprint planning. Ten runtime-touching scenarios land as VF-048 through VF-057; decoder-refusal tests ship as plain vitest under `tests/harness/`. Registry delta: none. Runtime delta: none. Phase F ships a bench; the Physical Presence boundary at Phase E close is the runtime substrate the bench exercises.
