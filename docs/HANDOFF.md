...
- **A green test whose claim is not trusted:** suppress the guard it names, run the test, watch it go red, restore. A test that stays green under a targeted mutation is decoupled from what it claims to prove. Addendum A practice #3; caught the vacuous audit test in the 2026-08-25 red-team pass.
