...
| [phases/PHASE_C_READOUT.md](phases/PHASE_C_READOUT.md) | Phase C summary. The 24-sprint arc (029-052), what went into the registries, what stayed as fields versus records, what was deferred, the red-team pass's three findings. |
| [notes/SESSION_2026-08-25.md](notes/SESSION_2026-08-25.md) | Day narrative for Phase C close. 30 commits, 24 sprints, 8,299 insertions across 112 files, 21 new test files. Commit ledger at the bottom. |
| [acceptance/RECEIVING_ACCEPTANCE.md](acceptance/RECEIVING_ACCEPTANCE.md) | The receiving-evidence boundary scored against its §27 — 14 of 15 pass, one passes in part. Each row cites the artifact that settles it. |
| [acceptance/ACCESS_AND_VISIBILITY_ACCEPTANCE.md](acceptance/ACCESS_AND_VISIBILITY_ACCEPTANCE.md) | The access-and-visibility boundary scored against its §16 — 18 of 18 pass or pass-in-part. Each row cites the artifact that settles it. |
| [acceptance/UI_SURFACE_ACCEPTANCE.md](acceptance/UI_SURFACE_ACCEPTANCE.md) | The UI surface design scored against its §25 — 21 of 21 pass or pass-in-part. 47 screens across 66 canvas artefacts, station-by-station breakdown, two open boundaries recorded. |
| [acceptance/PHYSICAL_PRESENCE_ACCEPTANCE.md](acceptance/PHYSICAL_PRESENCE_ACCEPTANCE.md) | The Physical Presence Boundary scored against its §15 — 33 of 33 pass or pass-in-part. Two new records, six operations, seven events, one state machine, four authorization rules, 31 failure classes, nine scenarios (VF-038 through VF-046), 17-arm mutation suite, scan contract as a harness surface. |
| [phases/PHASE_D_PLAN.md](phases/PHASE_D_PLAN.md) | The Phase D task breakdown — 38 sprints (053-090), five sub-phases, the canvas layout plan, and the two remediation passes at the tail. |
| [notes/DEVIATION_SUMMARY.md](notes/DEVIATION_SUMMARY.md) | Quantified delta from the initial design: locked baseline, delta table, method, final status. |
| [notes/ADDITIONS.md](notes/ADDITIONS.md) | Every capability built on top of the original doc stack, with the new vocabulary it introduced and the test that proves it. |
...
| [dev/phase-handoffs/PHASE_G_HANDOFF.md](../dev/phase-handoffs/PHASE_G_HANDOFF.md) | Phase G closeout returned to the team that supplied the UI overlay spec: what came in (ui-overlay-spec-v0.4 + incoming-roadmap-v0.8), what shipped back (v0.9 baseline after five review passes; two replaced screens, five amended, six inspected-only no-change; six extended components + three new; four flow maps; six new docs including the Phase H input package), F2b + F2c hygiene arcs landed alongside without touching Phase G's zero-registry-delta claim, both triggers NOT FIRED, Desktop-first alpha recommended. Cites the six-level citation-drift-audit rule the arc surfaced. |
| [phases/PHASE_G_PLAN.md](phases/PHASE_G_PLAN.md) | The Phase G task breakdown — 13 sprints (126-138), seven sub-phases, the fifteen-screen scope under four outcome classes, the two triggers evaluated at close, the F2b addendum landing alongside. |
| [phases/phase-h-input-package.md](phases/phase-h-input-package.md) | Phase H's derived-endpoint input: 19 (screen, action) rows across seven Phase G screens with the seven-field shape (registered op / caller context / visibility profile / idempotency / refusal envelope / source). Four `proposed` markers on names Phase H's team will settle; every other name resolves against the shipped registries today. |
| [phases/phase-g-phase-m-trigger.md](phases/phase-g-phase-m-trigger.md), [phases/phase-g-handoff-a-track-2-trigger.md](phases/phase-g-handoff-a-track-2-trigger.md), [phases/phase-g-ij-recommendation.md](phases/phase-g-ij-recommendation.md), [phases/phase-g-screen-to-call-log-map.md](phases/phase-g-screen-to-call-log-map.md), [phases/phase-g-remaining-handoffs.md](phases/phase-g-remaining-handoffs.md) | Phase G closeout docs: both triggers NOT FIRED; Desktop-first alpha; per-changed-artboard evidence cite; every remaining handoff-F or handoff-A track 2 marker listed with its reason. |
