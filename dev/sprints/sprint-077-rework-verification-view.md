# Sprint 077 — ReworkVerificationView (Mac).
...
Author the ReworkVerificationView artboard. Shows rework action (ReworkRun), verification requirement, verification result (Verification), actor authority, run-close impact. Actions: `StartRework`, `CompleteRework`, `RequireVerification`, `VerifyRework`, `CloseNonconformance`, `CancelNonconformance`.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §15.5`
...
- `canvas/mac/ReworkVerificationView.dc.html`
