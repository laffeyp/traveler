# Sprint 071 — ReceivingCheckView (Mac).
...
Author the ReceivingCheckView artboard. Shows ReceivingCheck state (passed, blocked, failed), blockers[] (rule ids), required documents, present documents, quarantine state of any linked InventoryItem, corrective action, release eligibility. Actions: `RunReceivingCheck`, `ApplyReceivingCheckResultToInventory` (walks the InventoryItem transition), `OpenReceivingNonconformance`, `OpenSupplierCorrectiveAction`.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §5.4, §14.6`
...
- `canvas/mac/ReceivingCheckView.dc.html`
