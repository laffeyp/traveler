# Sprint 075 — ContainmentView (Mac).
...
Author the ContainmentView artboard. Shows QualityContainmentAction state (required, active), affected population, containment action, related inventory, related run, release condition. Actions: `StartQualityContainment` (walks to required), `ActivateQualityContainment` (walks to active), `DefineAffectedPopulation`.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §15.3`
...
- `canvas/mac/ContainmentView.dc.html`
