# Sprint 074 — NonconformanceView (Mac).
...
Author the NonconformanceView artboard. Shows source Measurement or ReceivingCheck, affected Run, affected InventoryItem, affected population, Nonconformance state (nine states), linked QualityContainmentAction, linked Disposition, linked ReworkRun, linked Verification, run-close impact. Actions per §9: `OpenNonconformance`, `DefineAffectedPopulation`, `RecordDisposition`, `StartRework`, `VerifyRework`, `CloseNonconformance`, `CancelNonconformance`.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §15.2`
...
- `canvas/mac/NonconformanceView.dc.html`
