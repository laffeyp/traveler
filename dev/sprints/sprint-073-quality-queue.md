...
Author the QualityQueue artboard. Reads through the `QualityQueue` projection. Rows: open Issue, open Nonconformance, containment_required, disposition_pending, verification_pending, receiving-originated Nonconformance, supplier corrective action Issue. Filters: needs_containment, needs_disposition, needs_verification, receiving_originated, run_blocking, close_blocking.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §15.1`
...
- `canvas/mac/QualityQueue.dc.html`
