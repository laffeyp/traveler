# Sprint 068 — ShipmentLineView (Mac).
...
Author the ShipmentLineView artboard. Shows part revision, expected quantity, received quantity, lot or serial, linked inventory (via `inventory_item` field), receiving checks history, current release eligibility. Primary action: `ReceiveInventory` (moves InventoryItem to `received`).
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §14.3`
...
- `canvas/mac/ShipmentLineView.dc.html`
