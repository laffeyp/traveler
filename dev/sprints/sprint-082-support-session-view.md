# Sprint 082 — SupportSessionView (Mac).
...
Author the SupportSessionView artboard. Shows SupportSession alias, actor, scope, reason, opened_at, expires_at, status (open or closed), records touched, views generated, attachments accessed, exports created. Actions: `OpenSupportSession`, `CloseSupportSession`. Expiry is a time predicate on `expires_at`; refusal reason on expired: `support_context_expired`.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §20.1`
...
- `canvas/mac/SupportSessionView.dc.html`
