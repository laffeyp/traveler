...
Author the ReceivingQueue artboard. Sections: awaiting_receipt, received_no_check, check_blocked, check_failed, check_passed_apply_pending, quarantined, ready_to_release, corrective_action_open. Filters over the same. Reads through `readRecordAsCaller` on Shipment, ShipmentLine, ReceivingCheck.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §14.1`
...
- `canvas/mac/ReceivingQueue.dc.html`
