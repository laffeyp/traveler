...
Author the ShipmentView artboard. Shows Shipment alias, supplier reference, customer/program/contract/factory-node context if set, Shipment state (created, received), shipment lines, packing list, purchase order, receiving status. Primary actions: `CreateShipment`, `AddShipmentLine`, `ReceiveShipment`. Any dimensional context on the record activates the Phase C access checks.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §14.2`
...
- `canvas/mac/ShipmentView.dc.html`
