# Sprint 072 — InventoryQuarantineView (Mac).
...
Author the InventoryQuarantineView artboard. Shows InventoryItem alias, quarantined reason (receiving-rule id or quality path), source ReceivingCheck or Nonconformance, actor, time, related quality record. Action: `ReleaseFromQuarantine` — refuses unless a fresh `ReceivingCheck` for the line reads `passed`. Secondary: `QuarantineRemovedInventory`, `ReleaseRemovedInventory`.
...
- `specs/ui-surface-design/ui-surface-design-spec-v0.3.md §14.7`
...
- `canvas/mac/InventoryQuarantineView.dc.html`
