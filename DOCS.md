...
| [HANDOFF.md](HANDOFF.md) | Full handoff for the next person picking this up. What the project is, where it stands, how to run it, where the code and docs live, the ten rules the next person must follow, what is deferred, deliberate non-goals, and a runbook for when something is on fire. |
